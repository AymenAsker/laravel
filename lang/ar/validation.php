...
return [
    ...
    'attributes' => [
        ...
        'export_at' => 'تاريخ الرسالة',
        'subject' => 'موضوع الرسالة',
        'main_id' => 'الجهة المرسلة',
        'sub_id' => 'الجهة المرسلة',
        'file_id' => 'ملف الحفظ',
        'note' => 'الملاحظات',
        'images' => 'الصور',
        'mainRecipient' => 'الجهة المرسل إليها',
        'subRecipient' => 'الصفة المرسل إليها',
        'outMain' => 'خارج الجهة',

        'received_serial_number' => 'رقم التسلسل',
        'export_received_at' => 'تاريخ الرسالة',

        'referrer_number' => 'رقم التسلسل',
        'received_at' => 'تاريخ الرسالة',
